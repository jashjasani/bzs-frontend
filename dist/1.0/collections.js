document.addEventListener("DOMContentLoaded",async function(){var t;let a=await fetch("https://bildzeitschrift.netlify.app/.netlify/functions/collection",{method:"GET",headers:{Authorization:sessionStorage.getItem("auth")}});function l(e,t,i){switch(e){case"":i.innerHTML="";for(var a of t)i.appendChild(a);break;case"First":t.sort((e,t)=>e.getAttribute("name").localeCompare(t.getAttribute("name"))),i.innerHTML="";for(var l of t)i.appendChild(l);break;case"Second":t.sort((e,t)=>t.getAttribute("name").localeCompare(e.getAttribute("name"))),i.innerHTML="";for(var n of t)i.appendChild(n);break;case"Third":t.sort((e,t)=>e.getAttribute("randid").localeCompare(t.getAttribute("randid"))),i.innerHTML="";for(var o of t)i.appendChild(o);break;case"Fourth":t.sort((e,t)=>t.getAttribute("randid").localeCompare(e.getAttribute("randid"))),i.innerHTML="";for(var r of t)i.appendChild(r)}}t=(a=await a.json()).subscription,a=a.collections,sessionStorage.setItem("collections",JSON.stringify(a)),window.editPopup=async t=>{var e=t.target.getAttribute("name")||"",i=t.target.getAttribute("cover")||"",a=t.target.getAttribute("description")||"";console.log(e);const l=await Swal.fire({title:"Edit collection",showCancelButton:!0,confirmButtonText:"Save",cancelButtonText:"Delete Collection",showCloseButton:!0,html:`
                ...
                <input value="${e}" type="text" id="swal-input1" name="name" placeholder="Enter collection name" class="input-field">
                </div>

                <div class="input-group">
                <label for="description" class="input-label">Description</label>
                <textarea id="swal-input2" name="description" rows="9" placeholder="Enter collection description" class="input-field">${a}</textarea>
                </div>
        
                `,focusConfirm:!1,preConfirm:()=>[document.querySelector("#swal-input1").value,document.querySelector("#swal-input2").value]});console.log(l),l.isConfirmed?fetch("https://bildzeitschrift.netlify.app/.netlify/functions/collection",{method:"PUT",headers:{Authorization:sessionStorage.getItem("auth")},body:JSON.stringify({name:e,update:{$set:{name:l.value[0].trim(),description:l.value[1].trim()}}})}).then(e=>{200==e.status&&(t.target.setAttribute("name",l.value[0].trim()),t.target.setAttribute("description",l.value[1].trim()),console.log(t.currentTarget),"IMG"==t.target.tagName?(t.target.parentElement.parentElement.querySelector(".collection_name").innerText=l.value[0].trim(),t.target.parentElement.setAttribute("name",l.value[0].trim()),t.target.parentElement.setAttribute("description",l.value[1].trim()),t.target.parentElement.parentElement.querySelector("a").href=t.target.parentElement.parentElement.querySelector("a").href.split("=")[0]+"="+l.value[0].trim()):(t.target.parentElement.querySelector(".collection_name").innerText=l.value[0].trim(),t.target.querySelector("img").setAttribute("name",l.value[0].trim()),t.target.querySelector("img").setAttribute("description",l.value[1].trim()),t.target.parentElement.querySelector("a").href=t.target.parentElement.querySelector("a").href.split("=")[0]+"="+l.value[0].trim()),t.target.parentElement.parentElement.setAttribute("name",l.value[0].trim()))}):l.isDismissed&&"cancel"==l.dismiss&&fetch("https://bildzeitschrift.netlify.app/.netlify/functions/collection?name="+e,{method:"DELETE",headers:{Authorization:sessionStorage.getItem("auth")}}).then(e=>{200==e.status&&("IMG"==t.target.tagName?t.target.parentElement:t.target).parentElement.remove()})},window.changeCover=async(t,i)=>{fetch("https://bildzeitschrift.netlify.app/.netlify/functions/collection",{method:"PUT",headers:{Authorization:sessionStorage.getItem("auth")},body:JSON.stringify({name:t,update:{$set:{cover:i}}})}).then(e=>{e.ok&&(Swal.close(),(e=document.querySelectorAll(`[name='${t}']`))[0].querySelector("img").src=e[0].querySelector("img").src.split("images")[0]+i,e[1].setAttribute("cover",i),e[2].setAttribute("cover",i))})},window.newFunction=async e=>{let t=await fetch("https://bildzeitschrift.netlify.app/.netlify/functions/collection?name="+e,{method:"GET",headers:{Authorization:sessionStorage.getItem("auth")}}),a="";if(t.ok){t=await t.json(),console.log(t);for(i of t.collection.items)a+=`<img src="https://res.cloudinary.com/wdy-bzs/image/upload/q_10/v1651695832/images/${i.replaceAll("-","_").replaceAll("(","").replaceAll(")","")}" onclick="changeCover('${e}','images/${i.replaceAll("-","_").replaceAll("(","").replaceAll(")","")}')">`}await Swal.fire({title:"Change your cover image",showCancelButton:!0,showConfirmButton:!1,cancelButtonText:"Cancel",width:899,html:`
            
                <div class="flex-container">
                   ${a}
                </div>
        
                `})};var e=document.querySelector(".w-layout-grid.collections_grid");let n="";for(let e=0;e<a.length;e++)null!=t&&"Inspiration"==t.plan?n+=`
                ...
                `;e.insertAdjacentHTML("beforeend",n),document.querySelector(".produvt-img-wrapper.w-inline-block").remove();e=document.getElementById("Filter-Kollektionen");e.value="",e.addEventListener("change",e=>{var t=document.querySelector(".w-layout-grid.collections_grid"),i=Array.from(t.children);console.log(i),l(e.target.value,i,t)}),null!=t&&"Inspiration"==t.plan&&document.querySelector(".button.new-collection.w-inline-block").addEventListener("click",async function(){const a=await Swal.fire({title:"New collection",showCancelButton:!0,confirmButtonText:"Save",showCloseButton:!0,html:`
                </div>
                <div class="input-group">
                <label for="name" class="input-label">Name*</label>
                ...
                `,focusConfirm:!1,preConfirm:()=>[document.querySelector("#swal-input1").value,document.querySelector("#swal-input2").value]});a.isConfirmed&&fetch("https://bildzeitschrift.netlify.app/.netlify/functions/collection",{method:"POST",headers:{Authorization:sessionStorage.getItem("auth")},body:JSON.stringify({name:a.value[0].trim(),description:a.value[1].trim()})}).then(e=>{var t,i;e.ok&&(e=document.querySelector(".w-layout-grid.collections_grid"),t=Array.from(e.children),(i=document.createElement("div")).className="collection_item_wrap",i.setAttribute("randid",document.querySelectorAll("[randid]").length),i.setAttribute("name",a.value[0].trim()),i.innerHTML=`
                            ...
                            `,t.push(i),l(document.getElementById("Filter-Kollektionen").value,t,e))})})});